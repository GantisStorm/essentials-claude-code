...
EXAMPLES:
  /beads-loop
  /beads-loop --label openspec:refactor-bullmq
  /beads-loop --label openspec:my-feature --max-iterations 20
...
The stop hook will keep you implementing until all beads are complete.
