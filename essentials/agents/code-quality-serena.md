...
2. **LSP semantic navigation** - Use LSP tools for accurate symbol discovery and reference tracking
...
- [ ] Validated improvement feasibility (file-editors can implement, checked with LSP)
