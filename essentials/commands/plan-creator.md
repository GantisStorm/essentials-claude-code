...
description: Create a comprehensive architectural plan for any task - detailed enough to feed directly into /implement-loop, Spec Kit, or OpenSpec
---
...
**IMPORTANT**: Keep orchestrator output minimal. User reviews the plan FILE directly.
...
│  │     • Read and analyze affected code                    │  │
│  │                                                         │  │
│  │  3. PLAN GENERATION                                     │  │
│  │     • Outcome specification                             │  │
│  │     • Architectural specification                       │  │
│  │     • Implementation steps                              │  │
│  │     • Exit criteria with verification commands          │  │
│  │                                                         │  │
│  │  4. WRITE PLAN FILE                                     │  │
│  │     → .claude/plans/{task-slug}-{hash5}-plan.md         │  │
│  └─────────────────────────────────────────────────────────┘  │
└───────────────────────────────────────────────────────────────┘
    │
    ▼
...
│  • Files to modify count                                      │
│  • Quality score                                              │
│  • Next steps: /implement-loop, Spec Kit, or OpenSpec        │
└───────────────────────────────────────────────────────────────┘
```
